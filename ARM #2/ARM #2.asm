...
Switch_Init:
      ...
      mov r1, #0x63000
      add r1, r1, r0
      mov r0, #GPIOPCTL    ;0x52C
      add r1, r1, r0

      ldr r0, [r1]
      orr r0, r0, #0xf    ;#0x000f000f
      str r0, [r1]

      mov r0, #GPIO_BASE   ;LOCK
      mov r1, #0x63000
      add r1, r1, r0
      mov r0, #GPIOLOCK    ;0x520
      add r1, r1, r0
...
Switch_Input:
      ...
      mov r1, #0x63000
      add r1, r1, r5
      mov r5, #0x7c           ;5-bit after masking
      add r1, r1, r5
