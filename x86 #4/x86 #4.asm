...
; Initialize three TSS fields														;
    mov eax, tss1
    mov dword [eax + 32], Task1
	mov dword [eax + 56], 0xA000
	mov dword [eax + 72], Video_SEL
	mov dword [eax + 76], LDT_CODE_SEL1
	mov dword [eax + 80], LDT_DATA_SEL1
	mov dword [eax + 84], LDT_DATA_SEL1
	mov dword [eax + 96], LDTR1
	
	mov eax, tss2
    mov dword [eax + 32], Task2
	mov dword [eax + 56], 0xB000
	mov dword [eax + 72], Video_SEL
	mov dword [eax + 76], LDT_CODE_SEL2
	mov dword [eax + 80], LDT_DATA_SEL2
	mov dword [eax + 84], LDT_DATA_SEL2
	mov dword [eax + 96], LDTR2
	
	mov eax, tss3
    mov dword [eax + 32], Task3
	mov dword [eax + 56], 0xC000
	mov dword [eax + 72], Video_SEL
	mov dword [eax + 76], LDT_CODE_SEL3_0
	mov dword [eax + 80], LDT_DATA_SEL3
	mov dword [eax + 84], LDT_DATA_SEL3
	mov dword [eax + 96], LDTR3
